...
class FederatedSimulation():
    ...
    federated_config = ConfigFederated(
        ...
        rounds = 41,                          # Number of rounds for sim in federated. From Stefanos Remove it if not needed
    ...
    ood_config = ConfigOod(
        ...
        # _______SIMULATION________
        enabled = True,                             # Enabling hdff and ood. 
        ...
        ood_protection = True,                     # IF ood protection (exluding) is enabled.  Pre-training disables OOD detection. From Stefanos Remove it if not needed
        ood_protection_thres = 0.5                  # Threshold for consider models being ood. 
    )
